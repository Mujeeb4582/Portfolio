const workData = [
  ...
  },
  {
    ...
    mobileImg: 'https://user-images.githubusercontent.com/109666020/221373541-9bd0ac0a-5c0f-4e19-b430-b6c81ba1f2bd.png',
    desktopImg: 'https://user-images.githubusercontent.com/109666020/221373541-9bd0ac0a-5c0f-4e19-b430-b6c81ba1f2bd.png',
    githubIcon: './images/popup-github.svg',
    liveIcon: './images/popup-live.svg',
    mobileTech: ['TailWindCSS', 'ES6 JavaScript', 'React', 'Redux', 'Rest-API', 'Unit testing', 'Git'],
    desktopTech: ['TailWindCSS', 'ES6 JavaScript', 'React', 'Redux', 'Rest-API', 'Unit testing', 'Git'],
  ...
  },
  {
    ...
    projectDetail:
      ...
      Overall, this was an excellent opportunity for me to apply my programming skills and gain hands-on experience in creating a web application. I am proud of the final product and excited to continue building upon my knowledge in these programming languages for future projects.`,
    mobileImg: 'https://user-images.githubusercontent.com/109666020/221826371-cfaab064-8709-4584-bd02-6335c4aa9b24.png',
    desktopImg: 'https://user-images.githubusercontent.com/109666020/221826371-cfaab064-8709-4584-bd02-6335c4aa9b24.png',
    githubIcon: './images/popup-github.svg',
    liveIcon: './images/popup-live.svg',
  ...
  },
  {
    ...
    githubIcon: './images/popup-github.svg',
    liveIcon: './images/popup-live.svg',
    mobileTech: ['TailWindCSS', 'ES6 JavaScript', 'React', 'Redux', 'Rest-API', 'Unit testing', 'Git', 'Pair-Programming'],
    desktopTech: ['TailWindCSS', 'ES6 JavaScript', 'React', 'Redux', 'Rest-API', 'Unit testing', 'Git', 'Pair-Programming'],
  ...
  },
  {
    ...
    githubIcon: './images/popup-github.svg',
    liveIcon: './images/popup-live.svg',
    mobileTech: ['BootStrap', 'ES6 JavaScript', 'React', 'Redux', 'Rest-API', 'Unit testing', 'Git', 'Pair-Programming'],
    desktopTech: ['BootStrap', 'ES6 JavaScript', 'React', 'Redux', 'Rest-API', 'Unit testing', 'Git', 'Pair-Programming'],
  ...
  },
  {
    ...
    githubIcon: './images/popup-github.svg',
    liveIcon: './images/popup-live.svg',
    mobileTech: ['Ruby on Rails', 'TailWindCSS', 'Rails-RSpec', 'PostgreSQL', 'Unit test', 'Integration test', 'Rubocop-rails', 'Pair-Programming'],
    desktopTech: ['Ruby on Rails', 'TailWindCSS', 'Rails-RSpec', 'PostgreSQL', 'Unit test', 'Integration test', 'Rubocop-rails', 'Pair-Programming'],
...
function dynamicpro(proidx) {
  ...
  <div class="popup-action-btn">
    <a href="${myWork.liveLink}" class="resume" target="_blank">See Live<img src="${
  myWork.liveIcon
}" alt="Go-live"></a>
    <a href="${myWork.sourceLink}" class="resume" target="_blank">See Source<img src="${
  myWork.githubIcon
}" alt="Gitub-file"></a>
  </div>
  </div>
