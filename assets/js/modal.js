const workData = [
  ...
  },
  {
    ...
    githubIcon: './images/popup-github.svg',
    liveIcon: './images/popup-live.svg',
    Tech: ['TailWindCSS', 'ES6 JavaScript', 'React', 'Redux', 'Rest-API', 'Unit testing', 'Git'],
  ...
  },
  {
    ...
    githubIcon: './images/popup-github.svg',
    liveIcon: './images/popup-live.svg',
    Tech: ['TailWindCSS', 'ES6 JavaScript', 'React', 'Redux', 'Rest-API', 'Unit testing', 'Git', 'Pair-Programming'],
  ...
  },
  {
    ...
    githubIcon: './images/popup-github.svg',
    liveIcon: './images/popup-live.svg',
    Tech: ['BootStrap', 'ES6 JavaScript', 'React', 'Redux', 'Rest-API', 'Unit testing', 'Git', 'Pair-Programming'],
  ...
  },
  {
    ...
    githubIcon: './images/popup-github.svg',
    liveIcon: './images/popup-live.svg',
    Tech: ['Ruby on Rails', 'TailWindCSS', 'Rails-RSpec', 'PostgreSQL', 'Unit test', 'Integration test', 'Rubocop-rails', 'Pair-Programming'],
...
function dynamicpro(proidx) {
  ...
  <ul class="popup-items"> ${myWork.Tech.map(
    (ele) => `<li>${ele}</li>`,
  ).join('')}</ul>
